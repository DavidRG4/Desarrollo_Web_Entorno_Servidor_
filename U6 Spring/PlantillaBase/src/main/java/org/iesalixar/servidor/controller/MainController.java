...
public class MainController {
	...
	public String addGet(Model model) {
		...
		model.addAttribute("departamento", depDTO);		
		return "add";
	}
	
	@PostMapping("/departments/add")
	public String addPost(@ModelAttribute DepartamentoDTO departamento) {
		
		Departamento depBD = new Departamento();
		depBD.setNombre(departamento.getNombre());
		depBD = departamentoService.insertDepartamento(depBD);
